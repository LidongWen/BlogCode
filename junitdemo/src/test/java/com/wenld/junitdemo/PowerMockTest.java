...
//        //when
//        when(mCalc.addPublic(ArgumentMatchers.anyInt(), ArgumentMatchers.anyInt()))
//                .thenReturn(0)
//                .thenReturn(1)
//                .thenReturn(2)
//                .thenReturn(3)
...
//
//        //when
//        when(mCalc,"addPrivate",anyInt(),anyInt())
//                .thenReturn(0)
//                .thenReturn(1)
//                .thenReturn(2)
//                .thenReturn(3)
...
//
//        //verify static
//        verifyPrivate(mCalc,Mockito.times(6)).invoke("addPrivate",anyInt(),anyInt());
//        verifyPrivate(mCalc,Mockito.atLeast(1)).invoke("addPrivate",anyInt(),anyInt());
//    }
//
//
//    @Test
...
//        PowerMockito.mockStatic(CaculeClass.class);
//
//        when(CaculeClass.class, "addPublicStatic", anyInt(), anyInt())
//                .thenReturn(0)
//                .thenReturn(1)
//                .thenReturn(2)
//                .thenReturn(3)
...
//        PowerMockito.mockStatic(CaculeClass.class);
//
//        when(CaculeClass.class, "addPrivateStatic", anyInt(), anyInt())
//                .thenReturn(0)
//                .thenReturn(1)
//                .thenReturn(2)
//                .thenReturn(3)
...
//
//            //verify
//             Assert.assertEquals(Whitebox.invokeMethod(CaculeClass.class,"addPrivateStatic",i, i), i);
//        }
//
//
//        //verify static
